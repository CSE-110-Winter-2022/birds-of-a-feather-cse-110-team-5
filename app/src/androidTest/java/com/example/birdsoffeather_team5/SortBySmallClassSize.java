...
public class SortBySmallClassSize {
    ...
    public void sortBySmallClassSize() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.year_input),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("2021"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.subject_input), withText("CSE"),
                        childAtPosition(
                                ...
                                8),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("MGT"));

        ViewInteraction appCompatEditText10 = onView(
                allOf(withId(R.id.subject_input), withText("MGT"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText11 = onView(
                allOf(withId(R.id.course_number_input), withText("20"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                7),
                        isDisplayed()));
        appCompatEditText11.perform(replaceText("45"));

        ViewInteraction appCompatEditText12 = onView(
                allOf(withId(R.id.course_number_input), withText("45"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
