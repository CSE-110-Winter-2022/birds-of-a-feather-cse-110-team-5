...
public class ImgURLTest {
    ...
    public void imgURLTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.editTextImageURL), withText("Image URL"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editTextImageURL), withText("Image URL"),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("Image UURLS"));

        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editTextImageURL), withText("Image UURLS"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.editTextImageURL),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText9 = onView(
                allOf(withId(R.id.editTextImageURL),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText9.perform(replaceText("https://media.discordapp.net/attachments/767229195306532877/877693106185699348/1629194401737.pnghttps"), closeSoftKeyboard());

        ViewInteraction appCompatEditText10 = onView(
                allOf(withId(R.id.editTextImageURL), withText("https://media.discordapp.net/attachments/767229195306532877/877693106185699348/1629194401737.pnghttps"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText11 = onView(
                allOf(withId(R.id.year_input),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText11.perform(replaceText("2022"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText13 = onView(
                allOf(withId(R.id.course_number_input),
                        childAtPosition(
                                ...
                                7),
                        isDisplayed()));
        appCompatEditText13.perform(replaceText("105"), closeSoftKeyboard());
